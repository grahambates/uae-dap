...
export class VariableFormatter {
  public static readonly DECIMAL_FORMATTER = new VariableFormatter(
    VariableDisplayFormat.DECIMAL
  );
  public static readonly HEXADECIMAL_FORMATTER = new VariableFormatter(
    VariableDisplayFormat.HEXADECIMAL
  );
  public static readonly BINARY_FORMATTER = new VariableFormatter(
    VariableDisplayFormat.BINARY
  );
  public static readonly ADDRESS_FORMATTER = new VariableFormatter(
    VariableDisplayFormat.ADDRESS
  );
  /** display format */
